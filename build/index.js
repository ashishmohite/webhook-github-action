...
const requests_1 = __webpack_require__(333);
try {
...
const node_fetch_1 = __importStar(__webpack_require__(467));
function requests(url = "", method = "GET", headers = "", data) {
    return __awaiter(this, void 0, void 0, function* () {
        const params = {
            method: method,
            headers: new node_fetch_1.Headers(JSON.parse(headers)),
        };
        if (method != "GET") {
            params.body = data;
        }
